/* moOde-radio-plus — Frontend Snippet V7.11
   Caricato come file autonomo da /var/www/js/
   Iniettato in header.php tramite install.sh
   ------------------------------------------------
   Three-Layer Guard:
   - Layer 1: intercetta $.fn.html (jQuery)
   - Layer 2: MutationObserver su img.src
   - Layer 3: Property hijack su MPD.json.coverurl
*/
...
;(function () {
    ...
    sendLog('moOde-radio-plus snippet V7.11 initialized.');
