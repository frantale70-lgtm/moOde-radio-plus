/* moode-sse-patch V7.10 — Black Box Logger + Kiosk Freeze Bulletproof Fix */
...
;(function () {
    ...
    sendLog('moode-sse-patch V7.10 initialized.');
    ...
    function installMutationGuard() {
        function tryInstall() {
            ...
            sendLog('MutationGuard installed successfully.');
        }
        tryInstall();
    }
